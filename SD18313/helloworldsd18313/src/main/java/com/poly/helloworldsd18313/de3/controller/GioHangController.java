package com.poly.helloworldsd18313.de3.controller;

import com.poly.helloworldsd18313.de3.entity.GioHang;
import com.poly.helloworldsd18313.de3.repository.GioHangRepository;
import com.poly.helloworldsd18313.de3.repository.KhachHangRepository;
...
public class GioHangController {
    ...
    @GetMapping("/search")
    public String search(GioHang gioHang, Model model) {
        model.addAttribute("listKhachHang", khachHangRepository.findAll());
        model.addAttribute("listGioHang", gioHangRepository.
