...
<body>
    ...
    <form action="/dich-vu/add" method="post">
        ...
        Trang Thai:
        <input type="radio" name="trangThai" value="1" ${phong.trangThai == "1" ? "checked" : ""}> Con phong
        <input type="radio"  name="trangThai" value="2" ${phong.trangThai != "1" ? "checked" : ""}> Het phong
        <br>
        Ghi chu: <input type="text" name="ghiChu" value="${phong.ghiChu}">
        <br>
        Loai Phong:
